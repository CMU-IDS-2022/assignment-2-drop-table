...
st.title("Regression Analysis on HIV indicators across the years")
...
### First Linear Regression Iteration ###

st.header("The dataframe with relevant feature columns grouped by Indicators for all countries across the years")


final_features_df = features_df[['Adults (ages 15+) and children (ages 0-14) newly infected with HIV','Antiretroviral therapy coverage (% of people living with HIV)',
...
st.header("Regression Plot for predicting Adults (ages 15+) and children (ages 0-14) newly infected with HIV")
