...
st.header("The original dataframe grouped by Indicators for all countries from 1990 - 2020")
...
st.header("Regression Plot Predicting Poeple Newly Infected with HIV")
